...
// vector<vector<double>> getGamma(int T, int N, vector<vector<double>>& alpha, vector<vector<double>>& beta){
...
// vector<vector<vector<double>>> getDiGamma(int T, int N,string obsSeq, vector<vector<double>>& alpha, vector<vector<double>>& beta, vector<vector<double>>&A, vector<vector<double>>&B, vector<double>& scaler){
//     map<char, int> obsMap = {
//     {'a', 0}, {'b', 1}, {'c', 2}, {'d', 3}, {'e', 4}, {'f', 5},
//     {'g', 6}, {'h', 7}, {'i', 8}, {'j', 9}, {'k', 10}, {'l', 11},
//     {'m', 12}, {'n', 13}, {'o', 14}, {'p', 15}, {'q', 16}, {'r', 17},
...
//     vector<vector<vector<double>>> diGamma(T, vector<vector<double>>(N, vector<double>(N)));

//     for(int t = 0; t < T-1; t++) {
//         for(int i = 0; i < N; i++) {
//             for(int j = 0; j < N; j++) {
//              diGamma[t][i][j] = alpha[t][i] * A[i][j] * B[j][obsMap[obsSeq[t+1]]] * beta[t+1][j] * scaler[t];
//             }
//         }
//     }
//     return diGamma;
